...
wk.register({
  ...
  ['<space>'] = {
    ...
    ["g"] = {
      ...
      P = { "<cmd>GitGutterPreviewHunk<cr>", "view code change diff"},
      D = { "<cmd>GitGutterDiffOrig<cr>", "view file diff"},
      n = { "<cmd>GitGutterNextHunk<cr>", "jump the changed block next"},
      N = { "<cmd>GitGutterPrevHunk<cr>", "jump the changed block prev"}
    },
    ["s"] = {
      name = "+search",
